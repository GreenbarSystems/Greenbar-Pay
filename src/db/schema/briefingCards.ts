...
export const briefingCards = pgTable(
  "briefing_cards",
  {
    ...
    /**
     * Phase 10 — D5 Pre-Approval Coaching. Deterministic, generated by
     * computeCoachingPrompts(invoice, vendorProfile, lineScores). Shape:
     * Array<{ code, severity, message, dollarImpact?, context? }>.
     * Empty array when no triggers fire. Same supersede lifecycle as
     * everything else on this row — the coaching the approver saw at
